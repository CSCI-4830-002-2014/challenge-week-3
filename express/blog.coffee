entries = [
  ...
  {
    id: 7
    title: "Big Data/HCI Learning Challenge"
    body: "Here is some cool stuff about Big Data"
    published: "9/14/2014"
  }
]
exports.getBlogEntries = ->
  entries
...
exports.getBlogEntry = (id) ->
  ...
  while i < entries.length
    return entries[i] if entries[i].id == id
    i++
